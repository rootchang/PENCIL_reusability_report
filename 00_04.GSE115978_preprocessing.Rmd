...
seurat_obj <- AddMetaData(seurat_obj, meta.new)
seurat_obj$cell_names = NULL
seurat_obj$ICBresponse = 0
seurat_obj$ICBresponse[seurat_obj$treatment=='Untreated'] = NA
seurat_obj$ICBresponse[seurat_obj$treatment=='OR'] = 1
seurat_obj$sex <- ifelse(seurat_obj$sex == "M", 1, 0)
...
# extract CD8T cells for tumor samples
```{r}

seurat_obj = readRDS(file = paste0(processed_dir, "seu_",sampleType_name,"_all_raw.rds")) 
