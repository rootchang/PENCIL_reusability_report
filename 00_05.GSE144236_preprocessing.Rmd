...
# Read the .h5 file
counts <- Read10X_h5(filename = paste0(data_dir, "SCC_GSE144236_expression.h5"))
...
phenotype_df = read.csv(file = paste0(data_dir,"SCC_GSE144236_CellMetainfo_table.tsv"), sep='\t')
phenotype_df = phenotype_df[,c(1,6,8:10)]
colnames(phenotype_df) = c('cell_names', 'cell_type', 'patient', 'sample', 'tissue')
phenotype_df$sex=1
phenotype_df$sex[phenotype_df$patient %in% c('P3', 'P4', 'P6')] = 0
phenotype_df$age=0
phenotype_df$age[phenotype_df$patient=='P1']=83
phenotype_df$age[phenotype_df$patient=='P2']=69
phenotype_df$age[phenotype_df$patient=='P3']=71
phenotype_df$age[phenotype_df$patient=='P4']=75
phenotype_df$age[phenotype_df$patient=='P5']=98
phenotype_df$age[phenotype_df$patient=='P6']=96
phenotype_df$age[phenotype_df$patient=='P7']=75
phenotype_df$age[phenotype_df$patient=='P8']=63
phenotype_df$age[phenotype_df$patient=='P9']=87
phenotype_df$age[phenotype_df$patient=='P10']=71
