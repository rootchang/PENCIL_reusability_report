...
#merged_seu = readRDS(file = paste0(processed_dir_train,"seu_",sampleType_name,"_all.rds"))
...
# exp_data = as.matrix(merged_seu_subset@assays[["RNA"]]@data[variable_genes,])
# exp_data_scale_t = scale(t(exp_data))
# scaled_center_train <- attr(exp_data_scale_t, "scaled:center")
# scaled_scale_train <- attr(exp_data_scale_t,"scaled:scale")
# exp_data_scaled <- t(exp_data_scale_t)
...
# exp_data_new = as.matrix(merged_seu_subset@assays[["RNA"]]@data[variable_genes,])
# exp_data_scale_t_new = scale(t(exp_data_new), center=scaled_center_train, scale=scaled_scale_train)
# exp_data_scaled <- t(exp_data_scale_t_new)
exp_data_scaled = merged_seu_subset@assays[["RNA"]]@scale.data[variable_genes,]
...
python 02.Run_PENCIL_csv.py /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE120575/seu_Tissue_CD8T_ICBresponse.csv /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE120575/seu_Tissue_CD8T_ICBresponse_cell_label_info.csv /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE120575/seu_Tissue_CD8T_ICBresponse_embedding_umap.csv GSE120575_Tissue_CD8T ICBresponse multi-classification 1,2 /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE115978/seu_Tissue_CD8T_ICBresponse.csv,/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE123813/seu_Tissue_CD8T_ICBresponse.csv,/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE166181/seu_PBMC_CD8T_ICBresponse.csv
