...
ROC_list <- lapply(result_list, function(df) {
  roc_curve <- roc(df$ICBresponse, df$GSVAscore)
...
#### Data (n=121): Liu, D., Schilling, B., Liu, D. et al. Integrative molecular and clinical modeling of clinical outcomes to PD1 blockade in patients with metastatic melanoma. Nat Med 25, 1916–1927 (2019). https://doi.org/10.1038/s41591-019-0654-5
