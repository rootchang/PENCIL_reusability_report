...
saveRDS(seurat_obj_t, file = paste0(processed_dir,"seu_",sampleType_name,".rds"))
...
celltypist --indata /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE182227/seu_Tissue.h5ad --model Immune_All_Low.pkl --outdir /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE182227/ --prefix Tissue_celltypist_ImmuneAllLow_ --majority-voting
...
saveRDS(merged_seu_subset, file = paste0(processed_dir,"seu_",sampleType_name,"_CD8T.rds"))

# B cells
merged_seu$B_cell <- ifelse(grepl("B cells|Plasma", merged_seu$cell_type_celltypist, ignore.case = F), "B-cells", "Other")
merged_seu_subset <- subset(merged_seu, subset = B_cell == "B-cells")
saveRDS(merged_seu_subset, file = paste0(processed_dir,"seu_",sampleType_name,"_B.rds"))
