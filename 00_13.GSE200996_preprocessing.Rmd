...
seu_Tissue = readRDS(file=paste0(processed_dir, "seu_Tissue_CD8T.rds"))

seu_PBMC = readRDS(file=paste0(processed_dir, "seu_PBMC_CD8T.rds"))

merged_seu = merge(seu_Tissue,seu_PBMC)

saveRDS(merged_seu, file = paste0(processed_dir,"seu_all_CD8T.rds"))
