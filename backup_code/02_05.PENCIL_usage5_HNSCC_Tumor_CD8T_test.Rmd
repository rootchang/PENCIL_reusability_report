...
dataset_test4 = 'GSE166181'
processed_dir_test4 <- paste0("/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/", dataset_test4, '/')
fig_dir_test4 = paste0("/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/", dataset_test4, "/Figures/")

dataset_test5 = 'GSE120575'
processed_dir_test5 <- paste0("/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/", dataset_test5, '/')
fig_dir_test5 = paste0("/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/", dataset_test5, "/Figures/")
...
DimPlot(merged_seu_subset, group.by = "tissue", raster=FALSE)+
  ...
  ggtitle("")
ggsave(filename = paste0(fig_dir_train, "UMAP_tissue_",sampleType_name,".png"), height = 120, width = 190, dpi = 800, units = "mm")
...
merged_seu_subset$tissue = 0 # all PBMC samples
...
python 02.Run_PENCIL_csv.py /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE139324/seu_all_CD8T_tissue.csv /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE139324/seu_all_CD8T_tissuecell_label_info.csv /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE139324/seu_all_CD8T_tissue_embedding_umap.csv GSE139324_all_CD8T Tumor multi-classification 2,1 /data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE164690/seu_all3samples_CD8T_tissue.csv,/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE162025/seu_all_CD8T_tissue.csv,/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE200996/seu_all_CD8T_tissue.csv,/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE166181/seu_PBMC_CD8T_tissue.csv,/data/Lab_ruppin/tiangen/CancerProject/02.PENCIL/03.Results/GSE120575/seu_Tissue_CD8T_tissue.csv
...
#### for test4 data
# load seurat object
merged_seu_subset = readRDS(file = paste0(processed_dir_test4,"seu_PBMC_CD8T_tissue_PENCIL.rds"))
...
saveRDS(object = merged_seu_subset, file = paste0(processed_dir_test4,"seu_PBMC_CD8T_tissue_PENCIL.rds")) 
