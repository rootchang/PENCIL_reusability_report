...
# Read the .h5 file
counts <- Read10X_h5(filename = paste0(data_dir, "HNSC_GSE180268_expression.h5"))
...
phenotype_df = read.csv(file = paste0(data_dir,"HNSC_GSE180268_CellMetainfo_table.tsv"), sep='\t')
