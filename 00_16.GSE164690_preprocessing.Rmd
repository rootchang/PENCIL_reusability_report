...
merged_seu = readRDS(file = paste0(processed_dir, "seu_all3samples.rds")) 
merged_seu$HPV = 1
merged_seu$sex = 1
merged_seu$smoking = 1
merged_seu$alcohol = 1
merged_seu$age = 55
merged_seu$age[merged_seu$patient=='HN16'] = 45

print(unique(merged_seu$cell_type_celltypist))
...
saveRDS(merged_seu_CD8T, file = paste0(processed_dir,"seu_all3samples_CD8T.rds"))
...
saveRDS(merged_seu_B, file = paste0(processed_dir,"seu_all3samples_B.rds"))
