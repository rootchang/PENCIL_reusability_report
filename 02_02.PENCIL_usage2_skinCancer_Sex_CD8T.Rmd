...
print(table(merged_seu_subset$sex))
...
#merged_seu_subset$sex <- ifelse(merged_seu_subset$sex == "M", 1, 0)
...
#### for training data
# load seurat object
merged_seu_subset = readRDS(file = paste0(processed_dir_train,"seu_Tissue_CD8T_PENCIL.rds"))
...
saveRDS(object = merged_seu_subset, file = paste0(processed_dir_train,"seu_Tissue_CD8T_PENCIL.rds")) 


#### for test1 data
# load seurat object
merged_seu_subset = readRDS(file = paste0(processed_dir_test1,"seu_Tissue_CD8T_PENCIL.rds"))
...
saveRDS(object = merged_seu_subset, file = paste0(processed_dir_test1,"seu_Tissue_CD8T_PENCIL.rds")) 


#### for test2 data
# load seurat object
merged_seu_subset = readRDS(file = paste0(processed_dir_test2,"seu_Tissue_CD8T_PENCIL.rds"))
...
saveRDS(object = merged_seu_subset, file = paste0(processed_dir_test2,"seu_Tissue_CD8T_PENCIL.rds")) 


#### for test3 data
# load seurat object
merged_seu_subset = readRDS(file = paste0(processed_dir_test3,"seu_Tissue_CD8T_PENCIL.rds"))
...
saveRDS(object = merged_seu_subset, file = paste0(processed_dir_test3,"seu_Tissue_CD8T_PENCIL.rds")) 
...
ratios_R = df_ratios_yes$ratio[df_ratios_yes$sex==1]
ratios_NR = df_ratios_yes$ratio[df_ratios_yes$sex==0]
result <- wilcox.test(ratios_R, ratios_NR, alternative = "greater")
print(paste("Hypothesis R > NR: ",result$p.value))

roc_curve <- roc(df_ratios_yes$sex, df_ratios_yes$ratio)
auc_value <- auc(roc_curve)
acc_value = mean(df_ratios_yes$sex == as.numeric(df_ratios_yes$ratio>50))
print(paste('AUC = ', auc_value, '. ACC = ', acc_value))

# Plot the stacked bar plot
ggplot(df_ratios, aes(x = meta, y = ratio, fill = PENCIL_pred_label_sex)) + # paste0("PENCIL_pred_label_", phenotype_name)
