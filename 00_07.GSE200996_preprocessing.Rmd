...
keep_columns <- c("orig.ident", "nCount_RNA", "nFeature_RNA", "percent.mt", "meta", "patient", "timePt", "Sex", "Age", "TobaccoUse", "Downstaging", "RECIST_response", "Volumetric_response", "Viable_Tumor", "Pathological_response", "Pathological_response_binned", "Max_response", "Any_response", "OS_days", "PFS_days", "PFS_event", "OS_event")
