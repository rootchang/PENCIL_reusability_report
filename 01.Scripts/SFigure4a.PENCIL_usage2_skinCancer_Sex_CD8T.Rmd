---
title: "Predict sex in skin cancer using PENCIL predicted sex-relevant CD8+T cells"
...
# Calculate R/NR cell number and ratios in each patient for all training and test datasets (Supplementary Figure 4a)
```{r}
