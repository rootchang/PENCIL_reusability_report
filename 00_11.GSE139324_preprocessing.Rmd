...
# CD8T cells from both tumor and PBMC (exclude healthy)
...
seurat_obj$B_cell <- ifelse(grepl("B|Plasma", seurat_obj$cell_type, ignore.case = F), "B-cells", "Other")
seurat_obj_B <- subset(seurat_obj, subset = B_cell == "B-cells")

# B cells from both tumor and PBMC
seurat_obj_B_disease <- subset(seurat_obj_B, subset = disease == "HNSCC")
saveRDS(seurat_obj_B_disease, file = paste0(processed_dir,"seu_all_B.rds"))
